  ...
  <section id="container" class="">
              ...
              <ul class="sidebar-menu">   
                ...
                <li class="sub-menu">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a class="" href="Accept-Requests.php">Accept Requests</a></li>                          
                          <li><a class="" href="">View Requests</a></li>
                      </ul>
                  </li> 
      ...
      <section id="main-content">
          <section class="wrapper">            
			  ...
			  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-home"></i> Accept Requests</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="index.php">Home</a></li>
                        <li><i class="fa fa-files-o"></i>Order Request</li>
                        <li><i class="fa fa-files-o
                        "></i>Accept Requests</li>
             ...
             <div class="panel-group m-bot20" id="accordion">
                          <div class="panel panel-default">
                              ...
                              <div id="collapseTwo" class="panel-collapse collapse">
                                  ...
                                  <div class="col-lg-2">
                                      <section>
                                          <div style="margin: 10px 0px 10px 900px"><a class="btn btn-success btn-sm" href="" title="Accept Order">Reject</a></div>
                                      </section>
                                    </div>
                                    <div class="col-lg-2">
                                      <section>
                                          <div style="margin: 10px 0px 10px 800px"><a class="btn btn-success btn-sm" href="" title="Accept Order">Accept</a></div>
                                      </section>
                                      </div>
                                  </div>
                              </div>
